...
export default function SignInForm() {
  ...
  const onSubmit = async (data: z.infer<typeof signInSchema>) => {
    if (isSubmitting || !data.password || !data.identifier) return;
    ...
    <div className="flex justify-center items-center min-h-screen bg-teal-700">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Input placeholder='Test- rajanpandeygiit31078379@gmail.com' {...field} />
                  <FormMessage />
                </FormItem>
              )}
            />
        ...
        <div className="text-center mt-4">
          <p>
            Not a member yet?{' '}
            <Link href="/sign-up" className="text-teal-400 hover:text-teal-600">
              Sign up
            </Link>
          </p>
        </div>
